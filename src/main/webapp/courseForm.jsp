	...
	if (request.getParameter("btnSubmit") != null) {
		if (request.getParameter("id") != null) {			
			if (request.getParameter("id") != null && isNumeric(request.getParameter("id"))) {
				id = getIntergerValue(request.getParameter("id"));
		...
		String termParam = checkRequiredField(request.getParameter("term"), "Course Term");
		String idParam = checkRequiredField(request.getParameter("id"), "Course Id");
		
		term = !termParam.equals("") && isNumeric(termParam, "Course Term")?Integer.parseInt(termParam):0;
		qCourse = course.getCourse(id);
